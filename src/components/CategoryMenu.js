...
export default function CategoryMenu({ categories }) {
  ...
  return (
    ...
    >
      <div>
        <Menu.Button className="inline-flex justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-50">
          {({ open }) => (
            <ChevronDownIcon
              aria-hidden="true"
      ...
      >
        <Menu.Items className="absolute rtl:right-0 ltr:left-0 z-10 mt-2 origin-top-right rounded-md bg-white shadow-lg focus:outline-none">
